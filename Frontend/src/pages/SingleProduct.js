  ...
  return (
    <>
          ...
          <div className="col-12 col-md-6">
            <div className="main-product-details">
              ...
              <div className="py-3">
                ...
                <div className="d-flex align-items-center gap-15 flex-column flex-md-row mt-2 mb-3">
                  ...
                  <div className={`cart-button-wrapper ${alreadyAdded ? 'ms-0' : 'ms-md-5'} d-flex align-items-center gap-30`}>
                    <button
      ...
      <Container class1="popular-wrapper py-5 home-wrapper-2">
        <div className="row">
          <div className="col-12">
            <h3 className="section-heading">our quality is the identity of our goods</h3>
          </div>
        </div>
        <div className="row">
